...
public class IMLoginListDialog extends JDialog implements IMConstants
{
  ...
  int m_nWidth = 500;
  int m_nHeight = 250;
  int m_nButtonWidth = 110;
  int m_nButtonHeight = 35;
  int m_nOffset = 40;
  int m_nTableOffset = 20;
  int m_nLabelHeight = 40;
  int m_nBorder = 8;
  int m_nButtonOffset = 10;
  
  DatabaseCreditentalStore m_dbStore = null;
  ArrayList<DatabaseCreditental> m_aCreditentals = null; 
  ...
  private void loadCreditentals() {
	m_dbStore = new DatabaseCreditentalStore();
	try {
